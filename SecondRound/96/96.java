...
public final class ClassSanityTester {
  ...
  private List<Object> generateEqualFactoryArguments(
    ...
    for (int i = 0; i < args.size(); i++) {
      ...
      Object shouldBeEqualArg = ***(param, newFreshValueGenerator());
      if (arg != shouldBeEqualArg
          ...
          && hashCodeInsensitiveToArgReference(
              factory, args, i, ***(param, newFreshValueGenerator()))) {
  ...
  private static @Nullable Object ***(Parameter param, FreshValueGenerator generator)
